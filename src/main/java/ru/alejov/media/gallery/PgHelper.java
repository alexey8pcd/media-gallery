...
public class PgHelper {
    ...
    public static void saveToDatabase(String jdbcPropertiesFilePath, List<Media> mediaList) throws IOException, SQLException {
        ...
        try (InputStream inputStream = Files.newInputStream(Path.of(jdbcPropertiesFilePath))) {
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            try (PreparedStatement preparedStatement = connection.prepareStatement("""
                ...
                for (Media media : mediaList) {
                    ...
                    preparedStatement.setArray(4, connection.createArrayOf(JDBCType.VARCHAR.getName(), new String[]{media.path()}));
